# M-FORECASTING-044 — Transmission-dynamics and forecasting models

## Discovery control
- Method ID: M-FORECASTING-044
- Verification state: discovery
- Preliminary family: forecasting_dynamics
- Canonical discovery label: Transmission-dynamics and forecasting models
- Known label variants: None documented at discovery stage
- Linked discovery paper IDs: P-2021-0168 | P-2024-0462
...
## Lineage candidates
- NS-FORECASTING-085 | role=infectious_application | status=resolved_identity_role_unverified | identity=PMID:40018634 | searches=SEARCH-20260722-LINEAGE-FORECASTING-189 | URL=https://pubmed.ncbi.nlm.nih.gov/40018634/
