# M-SURVEILLANCE-083 — Travel-volume denominator risk estimation

## Discovery control
- Method ID: M-SURVEILLANCE-083
- Verification state: discovery
- Preliminary family: surveillance_measurement
- Canonical discovery label: Travel-volume denominator risk estimation
- Known label variants: Denominator and population-at-risk sensitivity | denominator_population_sensitivity | travel_volume_denominator_risk_estimation
- Linked discovery paper IDs: P-2017-0287 | P-2018-0318
...
## Lineage candidates
- NS-SURVEILLANCE-098 | role=infectious_application | status=resolved_identity_role_unverified | identity=PMID:28537548 | searches=SEARCH-20260719-LINEAGE-SURVEILLANCE-98 | URL=https://pubmed.ncbi.nlm.nih.gov/28537548/
