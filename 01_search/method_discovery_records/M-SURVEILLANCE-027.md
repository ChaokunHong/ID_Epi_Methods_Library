# M-SURVEILLANCE-027 — HAI rate denominator choice

## Discovery control
- Method ID: M-SURVEILLANCE-027
- Verification state: discovery
- Preliminary family: surveillance_measurement
- Canonical discovery label: HAI rate denominator choice
- Known label variants: None documented at discovery stage
- Linked discovery paper IDs: P-2011-0059 | P-2015-0068
...
## Lineage candidates
- NS-SURVEILLANCE-042 | role=diagnostic | status=resolved_identity_role_unverified | identity=PMID:25782986 | searches=SEARCH-20260722-LINEAGE-SURVEILLANCE-149 | URL=https://pubmed.ncbi.nlm.nih.gov/25782986/
