# M-SURVEILLANCE-030 — Incidence sensitivity to denominator source

## Discovery control
- Method ID: M-SURVEILLANCE-030
- Verification state: discovery
- Preliminary family: surveillance_measurement
- Canonical discovery label: Incidence sensitivity to denominator source
- Known label variants: Denominator and population-at-risk sensitivity | denominator_population_sensitivity | incidence_sensitivity_to_denominator_source
- Linked discovery paper IDs: P-2016-0084 | P-2021-0377
...
## Lineage candidates
- NS-SURVEILLANCE-045 | role=infectious_application | status=resolved_identity_role_unverified | identity=PMID:27572968 | searches=SEARCH-20260719-LINEAGE-SURVEILLANCE-45 | URL=https://pubmed.ncbi.nlm.nih.gov/27572968/
